...
-- -----------------------------------------------------
-- Table `CEBS_db`.`AccountStatus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CEBS_db`.`AccountStatus` (
...
-- -----------------------------------------------------
-- Table `CEBS_db`.`Admins`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CEBS_db`.`Admins` (
  `admin_id` INT NOT NULL COMMENT 'The ids for the admins\n',
  `user` INT NOT NULL COMMENT 'The user associated with the admin id.',
...
-- -----------------------------------------------------
-- Table `CEBS_db`.`Archvied Movies`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CEBS_db`.`Archvied Movies` (
...
CREATE TABLE IF NOT EXISTS `CEBS_db`.`Booking` (
  ...
  `promtionEntered` INT NULL COMMENT 'Which promotion has been entered, if any. ',
...
CREATE TABLE IF NOT EXISTS `CEBS_db`.`Credit Cards` (
  ...
  `card_number` INT NOT NULL COMMENT 'The encrypted cc#',
...
CREATE TABLE IF NOT EXISTS `CEBS_db`.`Customers` (
  ...
  CONSTRAINT `account_status`
    FOREIGN KEY (`status`)
    REFERENCES `CEBS_db`.`AccountStatus` (`status_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `userid`
    FOREIGN KEY (`user_id`)
...
CREATE TABLE IF NOT EXISTS `CEBS_db`.`Movies` (
  ...
  CONSTRAINT `category`
    ...
    REFERENCES `CEBS_db`.`Movie Categories` (`category_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `rating`
    FOREIGN KEY (`rating`)
    REFERENCES `CEBS_db`.`Ratings` (`ratings_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `CEBS_db`.`Ticket` (
  ...
  CONSTRAINT `ticket_type`
    ...
    REFERENCES `CEBS_db`.`TicketTypes` (`type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `booking`
    FOREIGN KEY (`booking`)
...
CREATE TABLE IF NOT EXISTS `CEBS_db`.`User` (
  ...
  PRIMARY KEY (`user_id`),
  INDEX `type_id_idx` (`account_type` ASC) VISIBLE,
  CONSTRAINT `type_id`
    FOREIGN KEY (`account_type`)
    REFERENCES `CEBS_db`.`User Types` (`type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `CEBS_db`.`User Types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CEBS_db`.`User Types` (
  `type_id` INT NOT NULL COMMENT 'The id for the two kinds of users.',
  `type` VARCHAR(8) NOT NULL COMMENT 'The string representation of the user type, customer or admin.\n',
  PRIMARY KEY (`type_id`),
